...
public class TextField extends JPanel implements IInputField {
    ...
    public void setEnabled(boolean enabled) {
        if (isAutoIncrement()) {
            formattedField.setEnabled(false);
            if (referenceBtn != null) {
                referenceBtn.setEnabled(false);
                referenceBtn.setVisible(false);
            }
            return;
        }
        ...
        if (referenceBtn == null) {
            ...
            formattedField.setEnabled(false);
            referenceBtn.setEnabled(true);
            referenceBtn.setVisible(true);
        }
    }
    ...
    public boolean isPrimary() {
        return Boolean.TRUE.equals(column.isPrimary()); 
    }

    @Override
    public boolean isNullable() {
        return Boolean.TRUE.equals(column.isNullable()); 
    }
    
    @Override
    public boolean isAutoIncrement() {
    	return Boolean.TRUE.equals(column.isAutoIncrement());
    }
