...
public class FieldGenerator {
    ...
    public static IInputField createInput(Column column) {
        ...
        // Ako kolona referencira drugu tabelu, uveži LinkedField (read-only + selektor)
    ...
    /**
     * Kreira i vraća {@link DefaultFormatter} sa prilagođenim formatiranjem brojeva.
     * 
     * Omogućava da prazna polja budu validna (vraća null) i onemogućava overwrite mod.
     * 
     * 
     * @param format Format broja koji će koristiti formatter
     * @return {@link DefaultFormatter} sa zadatim formatom
     */
