...
/**
 * Klasa {@code DynamicReportGenerator} omogućava generisanje dinamičkih izvještaja
 * iz baze podataka koristeći JasperReports i DynamicJasper biblioteke.
 * 
 * Omogućava korisniku da izabere kolone koje će biti uključene u izvještaj,
 * pregleda izvještaj ili ga sačuva u PDF formatu.
 * 
 */
public class DynamicReportGenerator {
     ...
     * Konstruktor klase.
     *
     * @param connection aktivna JDBC konekcija koja će se koristiti za izvlačenje podataka
     */
    ...
    /**
     * Generiše dinamički izvještaj na osnovu rezultata procedure iz baze podataka.
     * 
     * Nakon izvršenja procedure, korisniku se prikazuje dijalog za izbor kolona koje će biti
     * prikazane u izvještaju. Korisnik potom može da pregleda izvještaj ili da ga sačuva kao PDF.
     *
     * @param storedProcedure SQL poziv (npr. "{call procedura}") koji vraća ResultSet za izvještaj
     */
    public void generateReport(String storedProcedure) {
        ...
        try {
            ...
            drb.setTitle("Napredni izvještaj")
            ...
            if (choice == 0) {
                ...
                fc.setSelectedFile(new File("NapredniIzvjestaj.pdf"));
