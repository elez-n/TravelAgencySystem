...
public class MenubarButtonActionListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "apIzvjestaj":
			try {
		        ...
		        if (choice == 0) {
		            ...
		            fc.setSelectedFile(new File("IzvjestajAkcijskePonude.pdf"));
		...
		case "vpIzvjestaj":
			try {
		        ...
		        if (choice == 0) {
		            ...
		            JFileChooser fc = new JFileChooser();
		            fc.setSelectedFile(new File("IzvjestajVozniPark.pdf"));
		            if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
		                JasperExportManager.exportReportToPdfFile(jp, fc.getSelectedFile().getAbsolutePath());
		                JOptionPane.showMessageDialog(null, "PDF sačuvan.");
		            }
		...
		case "pIzvjestaj":
			try {
				String reportPath = "reports\\Putovanje.jrxml";
				JasperReport jr = JasperCompileManager.compileReport(reportPath);
				JasperPrint jp = JasperFillManager.fillReport(jr, null,conn);
				Object[] options = {"Pregled", "Sačuvaj PDF", "Otkaži"};
		        int choice = JOptionPane.showOptionDialog(null, "Izaberite opciju:", "Opcije izvještaja",
		        ...
		        if (choice == 0) {
		            ...
		            JFileChooser fc = new JFileChooser();
		            fc.setSelectedFile(new File("IzvjestajPutovanje.pdf"));
		            if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
		                JasperExportManager.exportReportToPdfFile(jp, fc.getSelectedFile().getAbsolutePath());
		                JOptionPane.showMessageDialog(null, "PDF sačuvan.");
		            }
		...
		case "cIzvjestaj":
			try {
				String reportPath = "reports\\Cjenovnik.jrxml";
				JasperReport jr = JasperCompileManager.compileReport(reportPath);
				JasperPrint jp = JasperFillManager.fillReport(jr, null,conn);
				Object[] options = {"Pregled", "Sačuvaj PDF", "Otkaži"};
		        int choice = JOptionPane.showOptionDialog(null, "Izaberite opciju:", "Opcije izvještaja",
		        ...
		        if (choice == 0) {
		            ...
		            JFileChooser fc = new JFileChooser();
		            fc.setSelectedFile(new File("IzvjestajCjenovnik.pdf"));
		            if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
		                JasperExportManager.exportReportToPdfFile(jp, fc.getSelectedFile().getAbsolutePath());
		                JOptionPane.showMessageDialog(null, "PDF sačuvan.");
		            }
